...
Dalam proyek compiler subset C, type checking memverifikasi bahwa operasi dilakukan pada tipe yang kompatibel (\texttt{int}, \texttt{float}) dan bahwa setiap identifier merujuk ke deklarasi yang valid. Input: AST proyek (Bab 9, Bagian~\ref{sec:ast-proyek-subset-c}) dan symbol table proyek (Bab 10). Type checker dipanggil setelah scope resolution, sebelum IR generation (Bab 12).
