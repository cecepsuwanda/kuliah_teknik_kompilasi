...
\begin{figure}[!htbp]
    ...
    \node[level] (local) {Local\\Optimization};
    \node[level, below=of local] (global) {Global\\Optimization};
    \node[level, below=of global] (inter) {Interprocedural\\Optimization};
...
\begin{figure}[!htbp]
    ...
    \node[box] (ir) {IR};
    \node[box, right=of ir] (local) {Local\\Optimize};
    \node[box, right=of local] (global) {Global\\Optimize};
    \node[box, below=of local] (opt-ir) {Optimized\\IR};
