...
Asumsi runtime untuk proyek compiler subset C (stack/activation record, layout variabel) dibahas di Bagian~\ref{sec:runtime-proyek-subset-c} dan dipakai oleh code generation (Bab 14).
