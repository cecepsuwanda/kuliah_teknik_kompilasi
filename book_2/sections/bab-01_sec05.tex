...
\subsection{Fase 1: Analisis Leksikal (Lexical Analysis)}
...
\subsection{Fase 3: Analisis Semantik (Semantic Analysis)}
...
\subsection{Fase 4: Generasi Kode Intermediate (Intermediate Code Generation)}
...
\subsection{Fase 5: Optimasi Kode (Code Optimization)}
...
\subsection{Fase 6: Generasi Kode (Code Generation)}
