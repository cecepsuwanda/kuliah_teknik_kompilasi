...
Pemahaman tentang symbol table dan scope management adalah dasar penting untuk implementasi semantic analysis yang akan dibahas dalam bab selanjutnya. Symbol table proyek subset C (\texttt{symtab.h}/\texttt{symtab.c}) dipakai oleh type checking (Bab 11) dan code generation (Bab 14) dalam pipeline compiler proyek.