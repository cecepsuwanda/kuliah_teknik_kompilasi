...
\begin{lstlisting}[language=bash, caption={build.bat - Build compiler}]
@echo off
...
Langkah-langkah untuk testing compiler lengkap:

\subsubsection{1. Build Compiler}
...
\subsubsection{3. Compile dengan Compiler}
...
REM Step 3: Compile with our compiler
