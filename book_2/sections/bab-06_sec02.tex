...
Pada bab ini kita mengimplementasikan \textbf{parser hand-written} (recursive descent) untuk \textbf{grammar proyek subset C} (Bab 5, Bagian~\ref{sec:grammar-proyek-subset-c}). Parser ini mengenali program, statement, declaration, assignment, print-statement, dan ekspresi dengan precedence/associativity yang sama dengan parser proyek di Bab 8 (\texttt{simplec.y}), sehingga berfungsi sebagai implementasi manual untuk bahasa yang sama dengan proyek.
