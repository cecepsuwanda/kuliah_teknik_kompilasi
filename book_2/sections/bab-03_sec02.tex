...
Pada bab ini kita mengimplementasikan \textbf{lexer hand-written} yang mengikuti \textbf{spesifikasi token proyek subset C} (Bab 1, Bagian~\ref{sec:spec-subset-c}). Token set (identifier, kata kunci \texttt{int}/\texttt{float}/\texttt{print}, literal, operator, punctuator) diseragamkan dengan spec agar contoh di bab ini konsisten dengan lexer proyek di Bab 4 (\texttt{simplec.l}) dan parser proyek di Bab 8.
